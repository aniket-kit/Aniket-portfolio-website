...
export default class Baked {
  ...
  setModels = () => {
    ...
    this.model.mail = this.resources.items.mail.scene;
    this.model.mail.name = "mail";
    ...
    // this.setMaterial(this.model.mail, this.model.material3);
    ...
    this.scene.add(this.model.mail);
  };
}